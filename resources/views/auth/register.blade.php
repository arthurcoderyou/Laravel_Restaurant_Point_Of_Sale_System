...
<body class="animsition">
    <div class="page-wrapper" >
        <div class="page-content--bge5" style="min-height: 120vh;">
            <div class="container">
                    ...
                    <div class="login-content">
                        ...
                        <div class="register-form " >
                            <form method="POST" action="{{ route('register') }}" >
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" style="margin-bottom: 5px;">register</button>
    ...
    <script src="{{ asset('theme/vendor/counter-up/jquery.counterup.min.j') }}s">
    </script>
